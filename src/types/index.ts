...
export const DEFAULT_MODEL_FREE: ModelType = "codex-cli";
export const DEFAULT_MODEL_PAID: ModelType = "codex-cli";
...
export const DEFAULT_SLASH_COMMANDS: SlashCommand[] = [
  {
    ...
    name: "refine-note",
    promptTemplate: "Refine this note for clarity while preserving meaning, structure, and vault conventions:\n\n{selection}",
    model: "codex-cli",
    description: "Refine the current selection with Codex",
    searchSetting: null,
  },
];
...
export const WORKSPACE_FOLDER = "VaultCodexAssistant";
